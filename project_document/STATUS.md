...
| 领域 | 状态 | 说明 |
|---|---|---|
| 对话中心 | In progress | 已有会话、消息、多轮历史、LLM/规则兜底和推理过程展示 |
...
| Agent 领域模型 | Ready for V1 boundary | 已新增 `com.anjing.module.agent.domain` 和 `application` 端口，暂不接管现有运行链路 |
