...
| 课堂材料 | Runtime workspace | README 已压缩为课堂入口，`DEMO_FLOW.md` 已按讲法/看哪里/证明什么收口，`TEACHING_DELIVERY_CHECKLIST.md` 和 `pnpm check:delivery` 可做交付前体检，`pnpm demo:classroom:local` 可做自动课前 smoke |
