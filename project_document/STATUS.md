...
| 渠道协议适配 | Runtime connected | `/api/channels/wechat|app|marketplace/inbound` 将真实渠道字段归一到标准 inbound 链路，控制台可发送成功/失败 contract examples，并展示 trace/evidence、平台验签 profile、协议差异和失败指标 |
