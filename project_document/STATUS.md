...
| 渠道协议适配 | Runtime connected | `/api/channels/wechat|app|marketplace/inbound` 将真实渠道字段归一到标准 inbound 链路，控制台可发送 contract examples 并展示 trace/evidence |
